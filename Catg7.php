...
$query = 'SELECT * FROM postss WHERE catg7 LIKE "y"  AND  status LIKE "p" ORDER BY date DESC';
...
<head>
	...
	<title>What,when,where | Catg7</title>
	...
	<div class="container">
	 ...
	 <nav>
		<ul>
			...
			<li class="current"><a href="catg7.php">Catg7</a></li>
