...
$query = 'SELECT * FROM postss  WHERE catg4 LIKE "y" AND  status LIKE "p" ORDER BY date DESC';
...
<head>
	...
	<title>What,when,where | Catg4</title>
	...
	<div class="container">
	 ...
	 <nav>
		<ul>
			...
			<li  class="current"><a href="catg4.php">Catg4</a></li>
