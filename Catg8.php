...
$query = 'SELECT * FROM postss WHERE catg8 LIKE "y"  AND  status LIKE "p" ORDER BY date DESC';
...
<head>
	...
	<title>What,when,where | Catg8</title>
	...
	<div class="container">
	 ...
	 <nav>
		<ul>
			...
			<li class="current"><a href="catg8.php">Catg8</a></li>
