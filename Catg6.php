...
$query = 'SELECT * FROM postss WHERE catg6 LIKE "y"  AND  status LIKE "p" ORDER BY date DESC';
...
<head>
	...
	<title>What,when,where | Catg6</title>
	...
	<div class="container">
	 ...
	 <nav>
		<ul>
			...
			<li class="current"><a href="catg6.php">Catg6</a></li>
