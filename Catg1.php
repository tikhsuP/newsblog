...
$query = 'SELECT * FROM postss WHERE catg1 LIKE "y" AND  status LIKE "p" ORDER BY date DESC';
...
<head>
	...
	<title>What,when,where | Catg1</title>
	...
	<div class="container">
	 ...
	 <nav>
		<ul>
			...
			<li class="current"><a href="catg1.php">Catg1</a></li>
			...
			<li><a href="catg9.php">Catg9</a></li>
