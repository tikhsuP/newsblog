...
$query = 'SELECT * FROM postss WHERE catg2 LIKE "y" AND  status LIKE "p" ORDER BY date DESC';
...
<head>
	...
	<title>What,when,where | Catg2</title>
	...
	<div class="container">
	 ...
	 <nav>
		<ul>
			...
			<li class="current"><a href="catg2.php">Catg2</a></li>
