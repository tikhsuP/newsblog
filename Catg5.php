...
$query = 'SELECT * FROM postss WHERE catg5 LIKE "y" AND  status LIKE "p" ORDER BY date DESC';
...
<head>
	...
	<title>What,when,where | Catg5</title>
	...
	<div class="container">
	 ...
	 <nav>
		<ul>
			...
			<li class="current"><a href="catg5.php">Catg5</a></li>
