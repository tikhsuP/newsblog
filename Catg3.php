...
$query = 'SELECT * FROM postss WHERE catg3 LIKE "y" AND  status LIKE "p"  ORDER BY date DESC';
...
<head>
	...
	<title>What,when,where | Catg3</title>
	...
	<div class="container">
	 ...
	 <nav>
		<ul>
			...
			<li class="current"><a href="catg3.php">Catg3</a></li>
